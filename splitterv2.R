...
#FILE<-"C:/Users/jabbarc/Desktop/New folder/sanjiv_8000196147.csv"
 ...
 # class(DATE)
  ...
  write.table(alpha[,c(2,5:28)],file = paste0("H:/ENZYMOLOGY/ENVISION/raw_data/", DATE,"_paramita_R_writeout_alpha_",alpha$plate[1],"_",root), row.names = FALSE, sep = "\t")
  write.table(delta[,c(2,5:28)],file = paste0("H:/ENZYMOLOGY/ENVISION/raw_data/", DATE,"_paramita_R_writeout_delta_",delta$plate[1],"_",root), row.names = FALSE, sep = "\t")
  write.table(gamma[,c(2,5:28)],file = paste0("H:/ENZYMOLOGY/ENVISION/raw_data/", DATE,"_paramita_R_writeout_gamma_",gamma$plate[1],"_",root), row.names = FALSE, sep = "\t")
  write.table(p38[,c(2,5:28)],file = paste0("H:/ENZYMOLOGY/ENVISION/raw_data/", DATE,"_paramita_R_writeout_p38_",p38$plate[1],"_",root), row.names = FALSE, sep = "\t")
  #```
}
