...
##read in file path names  of that folder
 FILES<- list.files(path = "C:/Users/Jabbar/Desktop/TEST", full.names = TRUE )
  
  
 lip_eng<-function(FILE){ 
...
matches(match = c("Treatment","Cell","_nM"), ignore.case = TRUE, vars = colnames(df2))
